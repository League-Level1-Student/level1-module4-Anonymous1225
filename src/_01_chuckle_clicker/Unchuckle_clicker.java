...
public class Unchuckle_clicker implements ActionListener {
	Random ran = new Random();
	JFrame Nugget = new JFrame();
	JPanel Saltine = new JPanel();
	JButton Grace = new JButton();
	JButton Ducky = new JButton();
	public void makeButtons(){
		Nugget.add(Saltine);
		Saltine.add(Grace);
		Saltine.add(Ducky);
		Nugget.setVisible(true);
		Grace.addActionListener(this);
		Ducky.addActionListener(this);
		Grace.setText("Brainrot");
		Ducky.setText("Beemovie");
		Nugget.pack();
	}
	@Override
	public void actionPerformed(ActionEvent e) {
		// TODO Auto-generated method stub
		if(e.getSource()==Grace) {
			int br=ran.nextInt(4);
			if (br==0) {
				System.out.println("Do you know da wae");
			}
			if (br==1) {
				System.out.println("EErm WHat tHE siGma");
			}
			if (br==2) {
				System.out.println("There's something sticking out your gyatt for the rizzler");
			}
			if (br==3) {
				System.out.println("I just want to be your sigma");
			}
		}
		if(e.getSource()==Ducky) {
